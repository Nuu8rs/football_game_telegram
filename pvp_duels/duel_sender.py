...
Кожна ваша дія може вирішити результат ПВП-пеналті. Будьте напоготові і доведіть, що ваші ворота непробивні!
    """
    ...
    text_goal_scored = {
        RoleDuel.FORWARD: {
            "text" : (
                    ...
                    "<b>Рахунок ПВП-пеналті:</b> [{user_1_name}] <u>{points_user_1}</u> ➖ <u>{points_user_2}</u> [{user_2_name}]"),
            "photo" : FORWARD_GOAL}
